...
export const OptimismIcon = React.forwardRef<SVGSVGElement, IconProps>((props, forwardedRef) => {
  return (
    <svg
      width="32"
      height="32"
    ...
    >
      ...
      {/* The OP mark from @web3icons/core (MIT), scaled from its 24-unit frame. */}
