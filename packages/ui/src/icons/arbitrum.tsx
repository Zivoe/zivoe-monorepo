...
export const ArbitrumIcon = React.forwardRef<SVGSVGElement, IconProps>((props, forwardedRef) => {
  return (
    <svg
      width="32"
      height="32"
    ...
    >
      ...
      {/* The official Arbitrum One mark, scaled down from its 2500×2500 brand asset. */}
      <g transform="translate(4 4) scale(0.0096)">
        <path
