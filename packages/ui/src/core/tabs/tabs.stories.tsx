    ...
    return (
      <div className="w-150">
        ...
        <div className="mt-4 flex gap-2">
          <button onClick={() => setSelectedKey('tab1')} className="rounded-sm bg-element-primary px-3 py-1 text-base">
            Go to Tab 1
          </button>
          <button onClick={() => setSelectedKey('tab2')} className="rounded-sm bg-element-primary px-3 py-1 text-base">
            Go to Tab 2
          </button>
          <button onClick={() => setSelectedKey('tab3')} className="rounded-sm bg-element-primary px-3 py-1 text-base">
            Go to Tab 3
          </button>
        </div>
      </div>
