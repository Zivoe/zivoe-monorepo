    ...
    <EmailLayout preview="Ready to earn yield on private credit?">
      ...
      {accountType === 'individual' ? (
        <Text className="m-0 mb-4 leading-6 text-neutral-600">
          Just wanted to follow up and say thanks for signing up. As a refresher, Zivoe is designed to provide eligible
          users on-chain access to private credit strategies backed by real business cash flows.
        </Text>
      ) : (
        <Text className="m-0 mb-4 leading-6 text-neutral-600">
          Just wanted to follow up and say thanks for signing up. As a refresher, Zivoe is designed to provide on-chain
          access to private credit strategies linked to real business cash flows.
        </Text>
      )}
