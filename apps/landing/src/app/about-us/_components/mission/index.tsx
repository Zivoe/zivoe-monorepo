  ...
  return (
    <div className="bg-element-tertiary-gentle">
      <Container className="w-full items-start gap-10 py-10 sm:w-fit sm:items-center sm:py-32">
        ...
        <div className="flex flex-col items-start gap-4 sm:max-w-125 sm:items-center lg:max-w-180">
          ...
          <p className="text-regular text-primary sm:text-center sm:text-leading">
            ...
            markets that provide greater transparency, access, and efficiency. By building open financial infrastructure
