...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "insights_posts" ADD CONSTRAINT "insights_posts_author_id_authors_id_fk" FOREIGN KEY ("author_id") REFERENCES "public"."authors"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "insights_posts" ADD CONSTRAINT "insights_posts_category_id_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "insights_posts" ADD CONSTRAINT "insights_posts_seo_image_override_id_media_id_fk" FOREIGN KEY ("seo_image_override_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "_insights_posts_v" ADD CONSTRAINT "_insights_posts_v_version_featured_image_id_media_id_fk" FOREIGN KEY ("version_featured_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_insights_posts_v" ADD CONSTRAINT "_insights_posts_v_version_author_id_authors_id_fk" FOREIGN KEY ("version_author_id") REFERENCES "public"."authors"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_insights_posts_v" ADD CONSTRAINT "_insights_posts_v_version_category_id_categories_id_fk" FOREIGN KEY ("version_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_insights_posts_v" ADD CONSTRAINT "_insights_posts_v_version_seo_image_override_id_media_id_fk" FOREIGN KEY ("version_seo_image_override_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "insights_posts_featured_image_idx" ON "insights_posts" USING btree ("featured_image_id");
  CREATE INDEX "insights_posts_author_idx" ON "insights_posts" USING btree ("author_id");
  CREATE INDEX "insights_posts_category_idx" ON "insights_posts" USING btree ("category_id");
  CREATE INDEX "insights_posts_seo_image_override_idx" ON "insights_posts" USING btree ("seo_image_override_id");
  ...
  CREATE INDEX "_insights_posts_v_version_version_featured_image_idx" ON "_insights_posts_v" USING btree ("version_featured_image_id");
  CREATE INDEX "_insights_posts_v_version_version_author_idx" ON "_insights_posts_v" USING btree ("version_author_id");
  CREATE INDEX "_insights_posts_v_version_version_category_idx" ON "_insights_posts_v" USING btree ("version_category_id");
  CREATE INDEX "_insights_posts_v_version_version_seo_image_override_idx" ON "_insights_posts_v" USING btree ("version_seo_image_override_id");
